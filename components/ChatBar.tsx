...
export default function ChatBar() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Unable to connect to the AI assistant. Please try again later.");
    } finally {
      setLoading(false);
    }
      ...
      >
        ...
        >
          ...
          <span className={cn(
            ...
            {isExpanded
              ? isRecruiterMode ? "AI Job Match Analyzer" : "AI Assistant"
              : placeholder}
